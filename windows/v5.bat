...
powershell -Command "Get-AppxPackage *3DBuilder* -AllUsers | Remove-AppxPackage"
powershell -Command "Get-AppxPackage *Getstarted* -AllUsers | Remove-AppxPackage"
powershell -Command "Get-AppxPackage *WindowsAlarms* -AllUsers | Remove-AppxPackage"
powershell -Command "Get-AppxPackage *WindowsMaps* -AllUsers | Remove-AppxPackage" 
powershell -Command "Get-AppxPackage *SkypeApp* -AllUsers | Remove-AppxPackage"
powershell -Command "Get-AppxPackage *XboxApp* -AllUsers | Remove-AppxPackage"
powershell -Command "Get-AppxPackage *ZuneMusic* -AllUsers | Remove-AppxPackage"
powershell -Command "Get-AppxPackage *ZuneVideo* -AllUsers | Remove-AppxPackage"
powershell -Command "Get-AppxPackage *Solitaire* -AllUsers | Remove-AppxPackage"
powershell -Command "Get-AppxPackage *BingFinance* -AllUsers | Remove-AppxPackage"   
powershell -Command "Get-AppxPackage *BingNews* -AllUsers | Remove-AppxPackage"
powershell -Command "Get-AppxPackage *BingSports* -AllUsers | Remove-AppxPackage"
powershell -Command "Get-AppxPackage *BingWeather* -AllUsers | Remove-AppxPackage"
powershell -Command "Get-AppxPackage *Microsoft.Messaging* -AllUsers | Remove-AppxPackage"
powershell -Command "Get-AppxPackage *Bing* -AllUsers | Remove-AppxPackage"
powershell -Command "Get-AppxPackage *BingWeather* -AllUsers | Remove-AppxPackage"
powershell -Command "Get-AppxPackage *WindowsFeedbackHub* -AllUsers | Remove-AppxPackage"
powershell -Command "Get-AppxPackage *Cortana* -AllUsers | Remove-AppxPackage"
powershell -Command "Get-AppxPackage *OneNote* -AllUsers | Remove-AppxPackage"
powershell -Command "Get-AppxPackage *Photos* -AllUsers | Remove-AppxPackage"
powershell -Command "Get-AppxPackage *SkypeApp* -AllUsers | Remove-AppxPackage"
powershell -Command "Get-AppxPackage *WindowsPhone* -AllUsers | Remove-AppxPackage"
...
powercfg -setdcvalueindex 8c5e7fda-e8bf-4a96-9a85-a6e23a8c635c 637ea02f-bbcb-4015-8e2c-a1c7b9c0b546 9a66d8d7-4ff7-4ef9-b5a2-5a326ca2a469 %level%  
